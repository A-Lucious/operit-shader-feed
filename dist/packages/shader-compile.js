...
exports.shader_last_compile_result = shader_last_compile_result;
const compile_tool_js_1 = require("../plugin/compile-tool.js");
/**
 ...
 */
async function shader_last_compile_result() {
    return (0, compile_tool_js_1.readCompileResultText)((channel, payload) => ToolPkg.ipc.call(channel, payload));
}
