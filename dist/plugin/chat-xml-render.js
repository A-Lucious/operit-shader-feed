...
exports.SHADER_XML_RENDER_REGISTRATION = exports.SHADER_XML_TAG = void 0;
exports.decodeXmlEntities = decodeXmlEntities;
exports.stripCdata = stripCdata;
exports.precheckShaderCode = precheckShaderCode;
exports.extractShaderBody = extractShaderBody;
...
function precheckShaderCode(code) {
    ...
    if (text.startsWith("<")) {
        ...
        return ("代码以 `<` 开头 —— `<shader>` 标签外壳没剥干净（标签本身不该出现在代码里）。" +
            "请只把 GLSL 写在 `<" +
            exports.SHADER_XML_TAG +
            ">…</" +
            exports.SHADER_XML_TAG +
 ...
 */
function extractShaderBody(xmlContent) {
    const text = String(xmlContent).trim();
    const openPrefix = "<" + exports.SHADER_XML_TAG;
    ...
    const closeTag = "</" + exports.SHADER_XML_TAG + ">";
...
function parseShaderTag(xmlContent) {
...
function onShaderXmlRender(event) {
    const payload = event.eventPayload || {};
    if (payload.tagName !== exports.SHADER_XML_TAG) {
...
exports.SHADER_XML_RENDER_REGISTRATION = {
    id: "shader_inline_render",
    tag: exports.SHADER_XML_TAG,
