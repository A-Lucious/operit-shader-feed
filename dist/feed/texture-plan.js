...
exports.extFromUrl = extFromUrl;
exports.extFromFile = extFromFile;
exports.planTextureDownloads = planTextureDownloads;
exports.planChannelDispatch = planChannelDispatch;
exports.parseVirtualTexturePath = parseVirtualTexturePath;
/**
 ...
 */
function planTextureDownloads(channels) {
    const seen = {};
    const out = [];
 ...
 */
function planChannelDispatch(channels, lookup, virtualHost) {
    const out = [];
    for (const ch of channels) {
        if (!ch) {
            continue;
 ...
 */
function parseVirtualTexturePath(pathname) {
