...
import type { StoreEntry, StoreFs } from "./store.js";
 ...
 */
export const DEFAULT_STORE_ROOT = "/sdcard/Download/Operit/plugins/shader_feed";

/** 我们的根目录是 /sdcard/...，属 android 环境。 */
const ENV: FileEnvironment = "android";
...
export function createHostFs(): StoreFs {
  return {
    ...
    async list(path: string): Promise<StoreEntry[]> {
 ...
 */
export function hashTextureUrl(url: string): string {
 ...
 */
export async function verifyRootWritable(
  root: string,
